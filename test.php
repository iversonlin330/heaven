...
*/
	...
	try {
        ...
        $obj->Send['TotalAmount']       = $_POST['value'];                                       //交易金額
        $obj->Send['TradeDesc']         = "good to drink" ;                           //交易描述
        if($_POST['type'] == 'CVS'){
			$obj->Send['ChoosePayment']     = ECPay_PaymentMethod::CVS;
		}elseif($_POST['type'] == 'ATM'){
		...
		$obj->Send['OrderResultURL'] = $url."result.php";
        $obj->Send['CustomField1'] = $_POST['money'];
		$obj->Send['CustomField2'] = $_POST['account'];
		//訂單的商品資料
        array_push($obj->Send['Items'], array('Name' => "天堂幣", 'Price' => (int)$_POST['value'],
